...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      alert('Google Sign-In is not configured. Please use email/password to login.')
    }
  }
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderRadius: '50%', background: 'linear-gradient(135deg, rgba(124, 58, 237, 0.3) 0%, rgba(168, 85, 247, 0) 100%)', filter: 'blur(80px)',
      }} />
      <div style={{
        position: 'absolute', bottom: '-150px', right: '-150px', width: '400px', height: '400px',
        borderRadius: '50%', background: 'linear-gradient(135deg, rgba(124, 58, 237, 0.2) 0%, rgba(168, 85, 247, 0) 100%)', filter: 'blur(100px)',
      }} />
      ...
      <div style={{ width: '100%', maxWidth: '420px', position: 'relative', zIndex: 1 }}>
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <h1 style={{ fontSize: '1.75rem', fontWeight: '700', color: '#0f172a', fontFamily: 'var(--font-serif)', marginBottom: '0.25rem' }}>Login</h1>
            <p style={{ color: '#64748b', fontSize: '0.95rem' }}>Sign in to your account to continue</p>
          </div>
          ...
          <p style={{ marginTop: '1.75rem', textAlign: 'center', fontSize: '0.9rem', color: '#64748b' }}>
            Don't have an account? <Link to="/register" style={{ color: '#7c3aed', fontWeight: '600', textDecoration: 'none' }}>Register</Link>
          </p>
        </div>
      </div>
    </div>
